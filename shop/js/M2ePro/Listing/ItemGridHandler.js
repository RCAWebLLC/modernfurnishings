...
ListingItemGridHandler.prototype = Object.extend(new CommonHandler(), {
        ...
        AmazonListingOtherAutoMapHandlerObj)
    {
        ...
        this.AmazonListingProductSearchHandlerObj = AmazonListingProductSearchHandlerObj;
        this.AmazonListingOtherAutoMapHandlerObj = AmazonListingOtherAutoMapHandlerObj;
        ...
        $$('select#'+self.gridId+'_massaction-select option').each(function(o) {
            if (o.selected) {
                ...
                switch (o.value) {
                    ...
                    case 'map_products':
                        self.AmazonListingOtherAutoMapHandlerObj.mapProductsAuto(selectedProductsString);
                        break;
                    ...
                    case 'map_to_asin':
                        self.AmazonListingProductSearchHandlerObj.searchAsinAuto(selectedProductsString);
                        break;

                    case 'unmap_asin':
                        self.AmazonListingProductSearchHandlerObj.unmapFromAsin(selectedProductsString);
                        break;
                }
            }
        });
