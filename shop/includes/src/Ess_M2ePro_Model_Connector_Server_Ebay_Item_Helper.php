...
class Ess_M2ePro_Model_Connector_Server_Ebay_Item_Helper
{
    ...
    public function getListRequestData(Ess_M2ePro_Model_Listing_Product $listingProduct, array $params = array())
    {
        ...
        if ($permissions['general']) {
            ...
            $requestData['use_local_shipping_rate_table'] = $listingProduct->getGeneralTemplate()
                ->getChildObject()->isUseEbayLocalShippingRateTableEnabled();
        }
        //-------------------
    ...
    protected function addShippingData(Ess_M2ePro_Model_Listing_Product $listingProduct, array &$requestData)
    {
        ...
        if ($listingProduct->getGeneralTemplate()->getChildObject()->isLocalShippingEnabled()) {
            ...
            if ($listingProduct->getGeneralTemplate()->getChildObject()->isLocalShippingCalculatedEnabled()) {
                ...
                $measurement_system = $listingProduct->getGeneralTemplate()
                    ->getChildObject()->getCalculatedShipping()->getMeasurementSystem();
                $originating_postal_code = $listingProduct->getGeneralTemplate()
                    ->getChildObject()->getCalculatedShipping()->getPostalCode();
            ...
            if ($listingProduct->getGeneralTemplate()->getChildObject()->isLocalShippingFlatEnabled() ||
                ...
                $requestData['shipping']['get_it_fast'] = $listingProduct->getGeneralTemplate()
                    ->getChildObject()->isGetItFastEnabled();
                $requestData['shipping']['dispatch_time'] = $listingProduct->getGeneralTemplate()
                    ->getChildObject()->getDispatchTime();
                $requestData['shipping']['local']['discount'] = $listingProduct->getGeneralTemplate()
                    ->getChildObject()->isLocalShippingDiscountEnabled();
                $requestData['shipping']['local']['cash_on_delivery'] = $listingProduct->getGeneralTemplate()
                    ->getChildObject()->isLocalShippingCashOnDeliveryEnabled();
                $requestData['shipping']['local']['cash_on_delivery_cost'] = $listingProduct
                    ->getChildObject()->getLocalShippingCashOnDeliveryCost();
        ...
        if ($listingProduct->getGeneralTemplate()->getChildObject()->isInternationalShippingEnabled() &&
            ...
            $requestData['shipping']['international']['discount'] = $listingProduct->getGeneralTemplate()
                ->getChildObject()->isInternationalShippingDiscountEnabled();
