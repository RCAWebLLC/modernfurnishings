...
class Ess_M2ePro_Model_Listing_Product_Variation_Updater
{
    ...
    public function updateVariations(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        ...
        // Get Variations
        //-----------------------------
        $variations = $listingProduct->getMagentoProduct()->getProductVariations();
        $magentoVariations = $this->prepareMagentoVariations($variations);
    ...
    public function isAddedNewVariationsAttributes(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        ...
        $magentoVariations = $this->prepareMagentoVariations(
            $listingProduct->getMagentoProduct()->getProductVariations()
        );
        $currentVariations = $this->prepareCurrentVariations(
            $listingProduct->getVariations(true)
        );
