    ...
    public function __construct()
    {
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'CommonHandlerObj.back_click(\''
                           .Mage::helper('M2ePro')->getBackUrl('*/adminhtml_order/index').'\')',
            'class'     => 'back'
        ));
        ...
        if ($this->order->getChildObject()->canUpdateShippingStatus()) {
            ...
            $this->_addButton('update_shipping_status', array(
                ...
                'onclick'   => "setLocation('".$this->getUrl('*/*/updateShippingStatus',
                                                             array('id' => $this->order->getId()))."');",
                'class'     => 'scalable'
            ));
        ...
        if ($this->order->getChildObject()->canCreateMagentoOrder()) {
            ...
            $this->_addButton('create_magento_order', array(
                'label'     => Mage::helper('M2ePro')->__('Create Order'),
                'onclick'   => "setLocation('".$this->getUrl('*/*/createMagentoOrder',
                                                             array('id' => $this->order->getId()))."');",
                'class'     => 'scalable'
            ));
