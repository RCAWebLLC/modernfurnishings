 ...
 */
class ExtensionsMall_CustomOptionSwatch_Model_Resource_Swatches extends Mage_Core_Model_Mysql4_Abstract {

    public function _construct() {
        $this->_init('custom_option_swatch/custom_option_swatch_images', 'entity_id');
    }
