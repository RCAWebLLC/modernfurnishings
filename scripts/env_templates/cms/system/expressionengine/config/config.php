...
$config['install_lock'] = "";
$config['license_number'] = '{{-EE_LICENSE-}}';
$config['debug'] = '1';
$config['cp_url'] = '{{-BASE_URL-}}cms/admin.php';
$config['doc_url'] = 'http://expressionengine.com/user_guide/';
$config['is_system_on'] = 'y';
$config['allow_extensions'] = 'y';
$config['site_label'] = '{{-EE_SITE_LABEL-}}';
...
$config['theme_folder_url'] = '{{-BASE_URL-}}cms/themes/';
$config['theme_folder_path'] = '{{-CMS_PATH-}}/themes/';
